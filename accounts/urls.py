...
urlpatterns = [
    ...
    # new
    # path("students/<int:pk>/send-activation-email/", send_activation_email, name="student_send_activation_email"),
    
    # ?NEW
    path('send-activation/<int:pk>/', send_activation_email, name='send_activation_email'),
