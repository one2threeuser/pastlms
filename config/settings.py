...
DEFAULT_FROM_EMAIL = config("EMAIL_FROM_ADDRESS", default=EMAIL_HOST_USER)
EMAIL_USE_SSL = False
...
# STRIPE_SECRET_KEY = config("11")
# STRIPE_PUBLISHABLE_KEY = config("111")
...
STUDENT_ID_PREFIX = config("STUDENT_ID_PREFIX", default="user")
