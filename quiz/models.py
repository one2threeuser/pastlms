...
class Quiz(models.Model):
    ...
    # NEW
    locked = models.BooleanField(default=True)  # True means locked, False means unlocked
...
#     score = models.FloatField()  # Store the quiz score
#     passed = models.BooleanField(default=False)  # Track pass/fail status

#     class Meta:
#         unique_together = ('user', 'module')  # Ensure one entry per user per module
...
class VideoProgress(models.Model):
    ...
    watched = models.BooleanField(default=False)  # True if the user watched the video

    # class Meta:
    #     unique_together = ('user', 'video')  # Ensure unique record per user per course
